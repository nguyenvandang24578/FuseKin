...
class MSCOCO(torch.utils.data.Dataset):
    def __init__(self, transform, data_split):
        ...
        self.img_path = osp.join(cfg.DATASET.jotr_data_root, 'MSCOCO', 'images')
        self.annot_path = osp.join(cfg.DATASET.jotr_data_root, 'MSCOCO', 'annotations')
        self.rootnet_output_path = osp.join(cfg.DATASET.jotr_data_root, 'MSCOCO', 'rootnet_output', 'bbox_root_coco_output.json')
